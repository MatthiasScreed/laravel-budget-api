...
// routes/api.php - VERSION COMPLÈTE CORRIGÉE MVP
...
use App\Http\Controllers\Api\DailyActionController;
...
// ==========================================
// ROUTES PROTEGEES (AUTH REQUIRED)
// ==========================================
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('quests')->name('quests.')->group(function () {
        ...
        Route::get('/main', [QuestController::class, 'main'])->name('main');
        ...
        Route::post('/{quest}/set-main', [QuestController::class, 'setMain'])->name('set-main');
        Route::get('/{quest}/projection-impact', [QuestController::class, 'projectionImpact'])->name('projection-impact');
    });

    // MVP — ACTIONS QUOTIDIENNES
    Route::prefix('daily-actions')->name('daily-actions.')->group(function () {
        Route::get('/', [DailyActionController::class, 'index'])->name('index');
        Route::post('/', [DailyActionController::class, 'store'])->name('store');
        Route::get('/today', [DailyActionController::class, 'today'])->name('today');
        Route::get('/yesterday', [DailyActionController::class, 'yesterday'])->name('yesterday');
        Route::get('/stats', [DailyActionController::class, 'stats'])->name('stats');
        Route::delete('/{dailyAction}', [DailyActionController::class, 'destroy'])->name('destroy');
    });
